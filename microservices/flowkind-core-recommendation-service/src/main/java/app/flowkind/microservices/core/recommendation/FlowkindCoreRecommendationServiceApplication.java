...
public class FlowkindCoreRecommendationServiceApplication {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(FlowkindCoreRecommendationServiceApplication.class);

    @Autowired
    ReactiveMongoOperations mongoTemplate;

    public static void main(String[] args) {
        ConfigurableApplicationContext configurableApplicationContext = SpringApplication.run(FlowkindCoreRecommendationServiceApplication.class, args);
